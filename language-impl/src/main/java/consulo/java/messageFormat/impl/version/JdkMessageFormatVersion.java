...
@ExtensionImpl
public class JdkMessageFormatVersion extends LanguageVersion implements LanguageVersionWithParsing, LanguageVersionWithDefinition {
    ...
    public boolean isMyElement(@Nullable PsiElement element) {
        ...
        return virtualFile != null && MessageFormatFileType.JDK_EXTENSION.equals(virtualFile.getExtension());
    }
